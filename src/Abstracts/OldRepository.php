...
abstract class OldRepository
{
    ...
    public function startQueryBuilder(object $query = null, ?string $for = null): self
    {
        if (!empty($for)) {
    ...
    public function buildQueryWithFilters(): self
    {
    ...
    public function buildQueryWithIncludes(): self
    {
    ...
    public function buildQueryWithSelects(): self
    {
    ...
    public function buildQueryWithSorts(): self
    {
